export default {
  translation: {
    ...
    errMsg: {
      minStr4: "باید بیشتر از ۴ کاراکتر باشد",
      minStr8: "باید بیشتر از ۸ کاراکتر باشد",
      maxStr15: "باید ۱۵ کاراکتر یا کمتر باشد",
