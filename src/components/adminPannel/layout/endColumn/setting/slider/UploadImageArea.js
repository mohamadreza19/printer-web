...
import { AdminAddImageSlide_Mutation } from "../../../../../../reactQuery/admin/callPostService";
import { t } from "i18next";

function UploadImageArea() {
  const [file, setFile] = useState("");
  const upload = AdminAddImageSlide_Mutation();
