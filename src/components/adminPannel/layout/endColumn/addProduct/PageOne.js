...
export default function PageOne() {
  ...
  function nextPage() {
    ...
    if (name.persian.length < 4) {
      callErr("name", "نام فارسی محصول کمتر از چهار کارکتر می باشد");
      return;
    }
    if (name.english.length < 4) {
      callErr("name", "نام انگلیسی محصول کمتر از چهار کارکتر می باشد");
      return;
    }
    if (name.turkish.length < 4) {
      callErr("name", "نام ترکی محصول کمتر از چهار کارکتر می باشد");
      return;
    }
  ...
  return (
    <div className={styles["page-1-container"]}>
      ...
      <section className={styles["input-box"] + " " + styles["input-medium"]}>
        <label>
          <Typography.H8>نام محصول </Typography.H8>
        </label>
        <LanguageSelectCards
      ...
      <section className={styles["input-box"] + " " + styles["input-medium"]}>
        <label>
          <Typography.H8>لینک محصول در سایت</Typography.H8>
        </label>
      ...
      <section className={styles["input-box"] + " " + styles["input-big"]}>
        <label>
          <Typography.H8>توضیحات تکمیلی درباره محصول</Typography.H8>
        </label>
        <LanguageSelectCards
