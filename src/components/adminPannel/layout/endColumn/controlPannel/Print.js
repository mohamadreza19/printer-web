...
export default function ({
  ...
  const fromNowDate = useFormetDate(print.updatedAt, language);
  return (
    <div className="w-100 bg_primary_v1 d-flex  border-r-25   mb-2 cur-pointer">
      ...
      >
        <Grid item lg={3}>
          <Typography.H9>{print.user.companyName}</Typography.H9>
          <Typography.H10>{print.createdBy}</Typography.H10>
        </Grid>
