...
export default function ({ param }) {
  ...
  useEffect(() => {
    if (res.data) {
      ...
      eP.target.value = res.data.name.persian;
      ...
      eE.target.value = res.data.name.english;
      handleSetEnglish(eE);
      ...
      eT.target.value = res.data.name.turkish;
      handleSetTurkish(eT);
    }
  }, [res.isSuccess]);
    ...
    return (
      <>
        ...
        >
          <article
            className={
              cssClass.me_3 + "  language-card-select position-absolute"
            }
            style={{
              zIndex: "2",
            }}
